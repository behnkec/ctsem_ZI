...
dat_scale <- dat_aggregated

dat_scale[, c("A1a", "A1b", "A3", "A9", "A4", "K3", "K4", "A8", "A6", "A2", "A5", "A7")] <- scale(dat_scale[, c("A1a", "A1b", "A3", "A9", "A4", "K3", "K4", "A8", "A6", "A2", "A5", "A7")])
```
...
### all participants without context
...
# Model fitting
fit_all <- ctStanFit(datalong = dat_scaled, ctstanmodel = model_all, priors = FALSE, optimize = TRUE) 
# priors: True -> HMC, false -> max likelihood
