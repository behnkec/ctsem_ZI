...
sim_ctsem <- function(n_sims, n_subjects, n_tpoints, alpha = 0.05){
  ...
  return(drift_results, drift_matrix_true)
}
```
...
```{r}
results <- sim_ctsem(500, 1, 200)

results_t_5000 <- sim_ctsem(50, 1, 5000)
...
boxplot(filtered_results$drift_symptom_severity)
...
boxplot(filtered_results_5000$drift_symptom_severity)
